...
public class BalanceLogEntry extends BaseEntity {
	...
	@Transient
	private static BalanceLogEntryRepository balanceLogEntryRepository;
	
	public static void setBalanceLogEntryRepository(BalanceLogEntryRepository repo) {
		balanceLogEntryRepository = repo;
	}
	
	public BalanceLogEntry save() {
		if (balanceLogEntryRepository == null) {
			throw new IllegalStateException("BalanceLogEntryRepository has not been set.");
		}
		return balanceLogEntryRepository.save(this);
	}
}
